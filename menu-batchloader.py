...
class menuBatchLoader(flameShotgunApp):
    ...
    def build_batch_loader_menu(self, entity):
        ...
        for step_name in step_names:
            ...
            for publish in publishes:
                if publish.get('task.Task.step.Step.short_name') == step_name:
                    ...
                    if published_file_type_name in types_to_include:
                        # assumption local to TC VFX pipeline
                        ...
                        menu_item = {}
                        menu_item['name'] = ' '*4 + publish.get('version.Version.code') + name_elements[-1]
